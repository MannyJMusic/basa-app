        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <Card className="hover:shadow-lg transition-shadow duration-300">
            <CardHeader>
              ...
              <CardTitle className="text-lg">Monthly Business Mixer</CardTitle>
              <CardDescription>
                Connect with fellow BASA members in a relaxed networking environment
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-3">
              ...
              <div className="flex space-x-2">
                <Button asChild size="sm" className="flex-1">
                  <Link href="/dashboard/events/1">View Details</Link>
                </Button>
          ...
          <Card className="hover:shadow-lg transition-shadow duration-300">
            <CardHeader>
              ...
              <CardTitle className="text-lg">Digital Marketing Workshop</CardTitle>
              <CardDescription>
            ...
            <CardContent className="space-y-3">
              ...
              <div className="flex space-x-2">
                <Button asChild size="sm" className="flex-1">
                  <Link href="/dashboard/events/2">View Details</Link>
                </Button>
                <Button variant="outline" size="sm">
                  Cancel
                </Button>
          ...
          <Card className="hover:shadow-lg transition-shadow duration-300">
            <CardHeader>
              ...
              <CardTitle className="text-lg">Community Giving Initiative</CardTitle>
              <CardDescription>
                Support local charities and make a difference in our community
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-3">
              <div className="flex items-center text-sm text-gray-600">
              ...
              <div className="flex space-x-2">
                <Button asChild size="sm" className="flex-1">
                  <Link href="/dashboard/events/3">View Details</Link>
                </Button>
                <Button variant="outline" size="sm">
                  Cancel
                </Button>

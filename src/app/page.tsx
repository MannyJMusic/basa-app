  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="relative basa-container text-center text-white z-40">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center animate-slide-up" style={{ animationDelay: '0.4s' }}>
              ...
              <Button asChild variant="outline" size="lg" className="border-gold-300/30 basa-text-navy hover:bg-gold-500/10 text-lg px-8 py-4 backdrop-blur-xs" style={{ boxShadow: '0 4px 8px rgba(0,0,0,0.3)' }}>
            ...
            <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 text-center animate-fade-in" style={{ animationDelay: '0.6s' }}>
              <div className="bg-white/10 backdrop-blur-xs rounded-xl p-6 border border-white/20" style={{ boxShadow: '0 6px 12px rgba(0,0,0,0.3)' }}>
      ...
      <section className="basa-section bg-basa-light-gray relative">
        <div className="absolute inset-0 bg-linear-to-b from-white to-basa-light-gray"></div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <Card className="basa-card group hover:scale-105 transition-all duration-500">
              <CardHeader className="text-center pb-6">
                <div className="w-20 h-20 bg-linear-to-br from-navy-500 to-navy-600 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
              ...
              <CardContent className="text-center">
                ...
                <ul className="text-left space-y-4 text-basa-charcoal">
                  <li className="flex items-start">
                    <CheckCircle className="w-5 h-5 text-navy-600 mr-3 mt-0.5 shrink-0" />
            ...
            <Card className="basa-card group hover:scale-105 transition-all duration-500">
              <CardHeader className="text-center pb-6">
                <div className="w-20 h-20 bg-linear-to-br from-gold-500 to-gold-600 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
              ...
              <CardContent className="text-center">
                ...
                <ul className="text-left space-y-4 text-basa-charcoal">
                  <li className="flex items-start">
                    <CheckCircle className="w-5 h-5 text-gold-600 mr-3 mt-0.5 shrink-0" />
            ...
            <Card className="basa-card group hover:scale-105 transition-all duration-500">
              ...
              <CardContent className="text-center">
                ...
                <ul className="text-left space-y-4 text-basa-charcoal">
                  <li className="flex items-start">
                    <CheckCircle className="w-5 h-5 text-teal-600 mr-3 mt-0.5 shrink-0" />
        ...
        <div className="relative basa-container text-center z-20">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              ...
              <Button asChild variant="outline" size="lg" className="border-white/30 basa-text-navy hover:bg-white/10 text-lg px-8 py-4 backdrop-blur-xs">

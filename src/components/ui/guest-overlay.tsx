  ...
  return (
    <div className={`absolute inset-0 flex flex-col items-center justify-center z-50 border-4 border-blue-400 rounded-2xl ${className}`} 
      ...
      <div className="bg-white/90 border-2 border-blue-400 rounded-2xl p-10 shadow-2xl text-center max-w-lg">
        <h2 className="text-3xl font-extrabold mb-4 text-blue-800 drop-shadow-sm">{title}</h2>
        ...
        <a href={ctaLink} className="inline-block bg-linear-to-r from-blue-600 to-purple-600 text-white font-bold py-3 px-8 rounded-full shadow-lg hover:scale-105 hover:from-purple-600 hover:to-blue-600 transition-transform duration-200">
          {ctaText} &rarr;
        </a>

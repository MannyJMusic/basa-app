...
const emptyDraft: Draft = { name: '', price: '', memberPrice: '', quantity: '', description: '' }
    ...
    <div className="space-y-3">
      ...
      {adding && (
        <div className="rounded-lg border border-blue-200 bg-blue-50 p-3">
          <DraftFields draft={adding} onChange={setAdding} idPrefix="new" />
...
function TierRow({ tier, busy, onSave, onToggle, onDelete }: {
  tier: AdminTier; busy: boolean
  ...
  return (
    <div className={`rounded-lg border p-3 ${tier.isActive ? '' : 'bg-gray-50 opacity-80'}`}>
      {!editing ? (
        ...
        <div>
          <DraftFields draft={draft} onChange={setDraft} idPrefix={tier.id} />
          <div className="mt-3 flex gap-2">
